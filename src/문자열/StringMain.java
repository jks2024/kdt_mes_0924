...
//        String text1 = new String("Hello Java"); // 권장되지 않는 방식
        ...
        // equals : 두개의 문자열이 동일하지 비교하여 결과값을 리턴 (오버라이딩 됨)
        String text1 = "hello";
        String text2 = "java";
        String text3 = "HELLO";
        ...
        String text4 = "안녕하세요. 자바 자바 자바 입니다. 오늘도 화이팅!!!!!";
        ...
        // replace() : 문장열에서 부분 문자열을 다른 문자열로 대체하거나 지울 때 사용
        ...
        String text7 = "안녕하세요.자바파이썬 자바스크립트 입니다.";
        ...
        // 문자열 포매팅 : 문자열에 내에 어떤 값을 삽입 하는 것 , printf()문와 거의 유사
